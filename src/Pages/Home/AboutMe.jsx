      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="about--section-description">
            Hello, I'm Jacob! Currently, I'm a Web Designer at OmniSence Digital, where I specialize in crafting engaging and user-friendly websites. By day, I immerse myself in the world of design, transforming ideas into visually appealing and functional digital experiences.
            <br/><br/>
